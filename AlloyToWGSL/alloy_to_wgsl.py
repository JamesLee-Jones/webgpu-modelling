...
def get_parent_id_from_ident(identifier) -> int:
...
def generate_global_var_decl(instance, global_var_decl_identifier, output_file):
    ...
    global_decl_parent_id = get_parent_id_from_ident("GlobalVarDecl")
...
def generate_compound_statement(instance, parent_identifier, output_file):
    ...
    statements = get_field_from_instance(instance, label="statements", parent_id=get_parent_id_from_ident("CompoundStatement"))
...
def generate_function_decl(instance, function_decl_identifier, output_file):
    ...
    function_decl_id = get_parent_id_from_ident(function_decl_identifier)
